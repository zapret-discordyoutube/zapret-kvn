...
class Node:
    ...
    country_code: str = ""  # runtime-only, never trust a persisted GeoIP guess
    ...
    def from_dict(data: dict[str, Any]) -> "Node":
        return Node(
            ...
            country_override=str(data.get("country_override") or ""),
...
class AppSettings:
    ...
    nodes_column_layout_version: int = 2
    nodes_group_by: str = "source"
    nodes_favorites_only: bool = False
    nodes_collapsed_groups: list[str] = field(default_factory=list)
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "nodes_group_by": self.nodes_group_by,
            "nodes_favorites_only": self.nodes_favorites_only,
            "nodes_collapsed_groups": list(self.nodes_collapsed_groups),
    ...
    def from_dict(data: dict[str, Any]) -> "AppSettings":
        return AppSettings(
            ...
            nodes_group_by=str(data.get("nodes_group_by", "source")),
            nodes_favorites_only=bool(data.get("nodes_favorites_only", False)),
            nodes_collapsed_groups=[str(v) for v in data.get("nodes_collapsed_groups", [])],
